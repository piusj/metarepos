...
- \`scripts/\` — helper scripts:
  - \`init-repos.mjs\` — idempotent materializer.
  - \`status.sh\` — cross-repo git status report (branches + worktrees).
- \`meta.code-workspace\` — VSCode multi-root workspace file (one folder per repo).
